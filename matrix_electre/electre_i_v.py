...
class ELECTRE_I_v:
    ...
    def e_I_v_Algorithm(
        ...
        array_p1 = Credibility.getCredibilityMatrixEI_v(array, v, weights, ei_v_p, ei_v_q)
        ...
        array_output1 = ELECTRE_I._build_matrix_block(
            "Concordance Matrix:", Concordance.getConcordanceMatrixEI_v(array, weights), n
        )
        array_output2 = ELECTRE_I._build_matrix_block(
            "Discordance Matrix:", Discordance.getDiscordanceMatrixEI_v(array, v), n
        )
        array_output3 = ELECTRE_I._build_matrix_block("Credibility Matrix:", array_p1, n)
